...
class ChatComplete extends AbstractChatMessage {
    ...
    private static final String CLIENT_PREFIX = ChatFormatting.GRAY + "[" + ChatFormatting.LIGHT_PURPLE + Kisman.NAME + ChatFormatting.GRAY + "] " + ChatFormatting.RESET;

    private TextComponentTranslation fModule(){
        return new TextComponentTranslation(ChatFormatting.GRAY + "[" + ChatFormatting.LIGHT_PURPLE + formatModule() + ChatFormatting.GRAY + "] " + ChatFormatting.RESET);
    }

    private TextComponentTranslation fClass(){
        return new TextComponentTranslation(ChatFormatting.GRAY + "[" + ChatFormatting.LIGHT_PURPLE + callerName() + ChatFormatting.GRAY + "] " + ChatFormatting.RESET);
    }
