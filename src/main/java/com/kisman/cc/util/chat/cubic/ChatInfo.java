...
class ChatInfo extends AbstractChatMessage {

    private static final String CLIENT_PREFIX = ChatFormatting.GRAY + "[" + ChatFormatting.GREEN + Kisman.NAME + ChatFormatting.GRAY + "] " + ChatFormatting.RESET;

    private TextComponentTranslation fModule(){
        return new TextComponentTranslation(ChatFormatting.GRAY + "[" + ChatFormatting.GREEN + formatModule() + ChatFormatting.GRAY + "] " + ChatFormatting.RESET);
    }

    private TextComponentTranslation fClass(){
        return new TextComponentTranslation(ChatFormatting.GRAY + "[" + ChatFormatting.GREEN + callerName() + ChatFormatting.GRAY + "] " + ChatFormatting.RESET);
    }
