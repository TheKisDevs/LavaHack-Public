...
import com.kisman.cc.gui.book.components.GenericButton;
import com.kisman.cc.util.nbt.SpecialTagCompound;
...
//          ((PreviewGui) parent).close();
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if(this.hasParent) {
      // Gui background
      Gui.drawRect(this.x, this.y, this.x_end, this.y_end, new Color(0, 0, 0, 255).getRGB()); // GUI background
